...
import { deletePendingOrderById } from '../../store/TradingAccountSlice';
...
const TradingAccountPendingOrderEntry = () => {
  ...
  const PendingOrdersRowsIds = useSelector(({ tradingAccountList }) => tradingAccountList.selectedPendingOrdersRowsIds )
  const PendingOrdersData = useSelector(({ tradingAccountList  })=> tradingAccountList.PendingOrdersData)
