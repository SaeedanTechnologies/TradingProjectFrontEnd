...
import { deleteLiveOrderById } from '../../store/TradingAccountSlice';


const TradingAccountLiveOrdersEntry = () => {
  const token = useSelector(({ user }) => user?.user?.token)
  const LiveOrdersRowsIds = useSelector(({ tradingAccountList }) => tradingAccountList.selectedLiveOrdersRowsIds)
  const LiveOrdersData = useSelector(({ tradingAccountList })=> tradingAccountList.LiveOrdersData)
      ...
      <div className='p-8' style={{ backgroundColor: colorBG }}>
        <div className='flex justify-between'>
          <div className='flex gap-3 items-center'>
            ...
            />
            {
              isDisabled ? <h1 className='text-2xl font-semibold'>Preview Trading Live Orders</h1> :
...
export default TradingAccountLiveOrdersEntry
