...
const SymbolGroupEntry = () => {
  ...
  const Controls = [
    ...
    { id: 2, control: 'CustomTextField', label: 'Symbol Group Laverage', varient: 'standard' },
    { id: 3, control: 'CustomTextField', label: 'Symbol Group Swap', varient: 'standard' },
    { id: 4, control: 'CustomTextField', label: 'Symbol Group Lot Size', varient: 'standard' },
    { id: 5, control: 'CustomTextField', label: 'SymbolmGroup Lot Steps', varient: 'standard' },
    { id: 6, control: 'CustomTextField', label: 'Volumn Minimum', varient: 'standard' },
    { id: 7, control: 'CustomTextField', label: 'Volumn Maximum', varient: 'standard' },
    { id: 8, control: 'CustomTextField', label: 'Symbol Group Trading Interval', varient: 'standard' },
  ]
