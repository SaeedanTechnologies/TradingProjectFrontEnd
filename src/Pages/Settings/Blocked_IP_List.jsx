...
import { Search_Blocked_IP, addToBlack_List, getActiveIPs, getBlockedIps } from '../../utils/_IPAddress';
...
const Blocked_IP_List = () => {
  ...
  const getActiveIpData = async() => {
      try{
          setIsLoading(true)
          const res = await getBlockedIps(token)
          setIsLoading(false)
...
export default Blocked_IP_List
